...
export default function FooterCTA() {
  return (
    ...
    <section className="relative overflow-hidden rounded-t-[28px] bg-[#0E0E0E]" style={{ minHeight: "260px" }}>
      ...
      {/* Dark scrim */}
      <div aria-hidden className="absolute inset-0 bg-[#0E0E0E]/70" />
      {/* Subtle amber warmth */}
      <div aria-hidden className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-amber-900/20 to-transparent" />

      {/* Centered content */}
      <div className="relative z-10 flex min-h-[220px] flex-col items-center justify-center px-6 py-8 text-center lg:px-10">
        <motion.div
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-7 py-3 text-sm font-medium tracking-wide text-white backdrop-blur-sm transition-[background-color,border-color] duration-200 hover:border-white/60 hover:bg-white/20 active:scale-[0.97]"
            >
              Contact Us
            </Link>
            <Link
